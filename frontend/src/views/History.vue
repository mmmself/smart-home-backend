...
.ae-row{display:grid;grid-template-columns:16px 110px 1fr 50px 1fr;gap:10px;align-items:center;padding:8px 4px;border-bottom:1px solid #1c2531;font-size:12px}
.ae-header{font-size:10px;color:#6b7686;padding-bottom:6px}
.ae-dot{width:8px;height:8px;border-radius:50%;flex-shrink:0}
.ae-time{font-family:'JetBrains Mono',monospace;color:#8b95a3;font-variant-numeric:tabular-nums}
.ae-action{font-weight:500}
.ae-method{font-size:11px;font-weight:500}
.ae-operator{color:#98a2b0}
.na-note{font-size:10px;color:#6b7686;padding:4px 0 8px;border-bottom:1px solid #1c2531;margin-bottom:6px}
